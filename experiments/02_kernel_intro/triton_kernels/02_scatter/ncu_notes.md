...
并和 `experiments/02_kernel_intro/cuda_kernels/02_scatter/ncu_notes.md` 里的 CUDA 版本对照。
...
launch__block_size \
  ...
  experiments/02_kernel_intro/triton_kernels/02_scatter/index_add_rows.py
```
