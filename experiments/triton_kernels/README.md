...
```bash
conda run -n aisys python experiments/triton_kernels/01_elementwise/elementwise_add.py
```

如果你已经激活了环境，也可以直接：

```bash
python experiments/triton_kernels/01_elementwise/elementwise_add.py
```
