...
并和 `experiments/cuda_kernels/05_layernorm/ncu_notes.md` 的 CUDA 版本对照。
...
launch__block_size \
  ...
  experiments/triton_kernels/05_layernorm/row_layernorm.py
```
...
launch__block_size \
  ...
  /data/home/tianjianyang/miniconda3/envs/aisys/bin/python \
  experiments/triton_kernels/05_layernorm/row_rmsnorm.py
```
