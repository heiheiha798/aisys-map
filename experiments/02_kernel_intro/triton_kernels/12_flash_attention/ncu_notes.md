...
并和 `experiments/02_kernel_intro/cuda_kernels/12_flash_attention/ncu_notes.md` 的 CUDA 教学版 FlashAttention 对照。
...
launch__block_size \
  ...
  experiments/02_kernel_intro/triton_kernels/12_flash_attention/flash_attention.py
```
