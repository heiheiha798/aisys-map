...
代码说明主要看 [bf16_cuda_core_vs_tensor_core.md](bf16_cuda_core_vs_tensor_core.md)，
库级对比主要看 [bf16_cublas_vs_ours.md](bf16_cublas_vs_ours.md)。
...
更完整的结果见 [ncu_notes.md](ncu_notes.md)。
