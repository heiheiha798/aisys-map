...
并和 `02_kernel_intro/cuda_kernels/08_fused_rmsnorm/ncu_notes.md` 的 CUDA 单 kernel fused 实现对照。
...
launch__block_size \
  ...
  02_kernel_intro/triton_kernels/08_fused_rmsnorm/fused_residual_rmsnorm.py
```
