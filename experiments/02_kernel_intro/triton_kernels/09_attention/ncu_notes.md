...
并和 `experiments/02_kernel_intro/cuda_kernels/09_attention/ncu_notes.md` 的 CUDA 版本对照。
...
launch__block_size \
  ...
  experiments/02_kernel_intro/triton_kernels/09_attention/triton_attention.py
```
