...
- `experiments/02_kernel_intro/triton_kernels/`
...
```bash
conda run -n aisys python experiments/02_kernel_intro/triton_kernels/01_elementwise/elementwise_add.py
```

如果你已经激活了环境，也可以直接：

```bash
python experiments/02_kernel_intro/triton_kernels/01_elementwise/elementwise_add.py
```
...
- [`experiments/05_case_studies/flash-deepseek-v2-lite/`](../../05_case_studies/flash-deepseek-v2-lite)
