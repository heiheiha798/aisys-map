...
并和 `experiments/02_kernel_intro/cuda_kernels/10_kv_cache/ncu_notes.md` 的 CUDA 版本对照。
...
launch__block_size \
  ...
  experiments/02_kernel_intro/triton_kernels/10_kv_cache/kv_cache_append_update.py
```
