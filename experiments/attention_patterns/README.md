...
```bash
python experiments/attention_patterns/dense_attention.py
python experiments/attention_patterns/window_attention.py
python experiments/attention_patterns/sparse_attention.py
python experiments/attention_patterns/linear_attention.py
```

如果用当前机器上的 `aisys` 环境：

```bash
conda run -n aisys python experiments/attention_patterns/dense_attention.py
conda run -n aisys python experiments/attention_patterns/window_attention.py
conda run -n aisys python experiments/attention_patterns/sparse_attention.py
conda run -n aisys python experiments/attention_patterns/linear_attention.py
```
